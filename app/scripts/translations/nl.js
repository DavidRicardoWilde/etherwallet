...
GAS_PRICE_Desc              : 'Gas Prijs is het bedrag dat je betaald per unit gas. `TX vergoeding = gas prijs * gas limiet` & wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. Des te hoger de gas prijs = de sneller je transactie, maar ook duurder. Standaard is `41 GSHA`.',
...
TXFEE_Desc                  : 'De TX vergoeding (`fee`) wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. De vergoeding is de `gas limiet` * `gas prijs`. [Je kunt hier GSHA -> ETH converteren](https://www.MoacWalletOnline.com/helpers.html)',
...
ERROR_10                    : 'Ongeldige gas bedrag. (Moet een getal zijn. Probeer 20 GSHA / 20000000000 WEI.) ',
