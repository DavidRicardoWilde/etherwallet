...
ERROR_10                        :  '(error_11) Please enter a valid gas price. (Must be an integer. Try 20 GSHA / 20000000000 SHA.)',
...
VIEWWALLET_Subtitle             :  'This allows you to download different versions of private keys and re-print your paper wallet. If you want to check your balance, we recommend using a blockchain explorer like [explorer.moac.io](http://explorer.moac.io/).',
...
x_Password                      :  'Password',
x_PasswordDesc                  :  '**Please type in a password(more than 9 digits in length) before click Create New Wallet button.** This password * encrypts * your private key. This does not act as a seed to generate your keys. **You will need this password + your private key to unlock your wallet.**',
...
HELP_0_Desc_1                   :  'MoacWalletOnline gives you the ability to generate new wallets so you can store your Ether yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**.',
