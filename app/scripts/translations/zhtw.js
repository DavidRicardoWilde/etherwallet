...
/* Onboarding */
ONBOARD_welcome_title           :  '歡迎來到 MoacWalletOnline.com',
...
NODE_Warning                : '你的節點必須使用HTTPS安全連線的方式才能夠由 MoacWalletOnline.com 連接到它。 你可以下載 [MyEtherWallet repo](https://github.com/kvhnuke/etherwallet/releases/latest) 並建立起一個你的節點來連接至其他的節點。或著從 [LetsEncrypt](https://letsencrypt.org/) 獲取免費的SSL憑證',
NODE_Name                   : '節點名稱',
NODE_Port                   : '節點連線的端口號碼',
...
ERROR_28                    : '**以後你會需要密碼和Keystore檔案** (或私鑰)來存取你的錢包。請儲存並備份在額外的地方！如果沒有儲存你是沒有機會找回這個錢包的。 詳見[幫助頁面](https://www.MoacWalletOnline.com/#help)來獲取更多資訊。 ',
