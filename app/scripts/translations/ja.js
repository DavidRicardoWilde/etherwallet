...
ERROR_10                    : '(error_11) 正しいガス価格を入力してください（整数である必要があります。20 GSHA（20000000000 WEI）でお試しください）。',
...
TXFEE_Desc                  : 'トランザクション手数料は、トランザクションをブロックへ組み込むためにマイナーに支払われます。`ガスリミット` × `ガス価格`で算出されます。 [GSHA -> ETHの単位変換はこちらからどうぞ](https://www.MoacWalletOnline.com/helpers.html)',　/*The TX Fee is paid to miners for including your TX in a block. It is the `gas limit` * `gas price`. [You can convert GSHA -> ETH here](https://www.MoacWalletOnline.com/helpers.html)*/
