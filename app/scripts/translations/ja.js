...
/* Onboarding */
ONBOARD_welcome_title           :  'いらっしゃいませ！ MoacWalletOnline.com へようこそ！', /*Welcome to MoacWalletOnline.com*/
...
ONBOARD_blockchain_content__5   :  'MyEtherWalletや[explorer.moac.io](http://explorer.moac.io)で残高や取引記録を確認すると、見えるのは私たちのシステムの中身ではなく、ブロックチェーン上にあるデータです。', /*When you see your balance on MoacWalletOnline.com or view your transactions on [explorer.moac.io](http://explorer.moac.io), you are seeing data on the blockchain, not in our personal systems.*/
...
ONBOARD_secure_1_content__3     :  'いつも、必ず、URLが「https://www.MoacWalletOnline.com」であるを確認してください。', /*Always check the URL: `https://www.MoacWalletOnline.com`.*/
...
PARITY_AlreadyImported      : "(parity-01) 同じハッシュのトランザクションが既にインポートされています。このトランザクションは既に送出されている可能性があります。トランザクションの重複を防ぐために、[explorer.moac.io](http://explorer.moac.io)でアドレスを確認してください。再送出しようとする前に10分間待機してください。[詳しくはこちら](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
...
PARITY_TooCheapToReplace    : "(parity-08) トランザクション手数料が低すぎます。ご利用のノードの最低額を満たしていません（最低額: (d+), 指定: (d+)）。ガス価格かガスリミットを上げてください。[詳細はこちら](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
  ...
  FOOTER_1                    : 'Ethereumウォレットを作成するための、無料で、オープンソースの、クライアントサイド・インターフェイス。Ethereumのブロックチェーンを簡単且つ安全に操作。お財布解錠の前に、URL( MoacWalletOnline.com )を再確認してください。',
FOOTER_1b                   : '制作者:',
...
NODE_Warning                : 'MoacWalletOnline.com 経由で接続するためには、HTTPSノードが必要です。[MyEtherWalletをレポジトリからダウンロードして、ローカル環境で実行させて](https://github.com/kvhnuke/etherwallet/releases/latest)、いずれかのノードに接続することもできます。または、無料のSSL証明書を[LetsEncrypt](https://letsencrypt.org/)から入手してください。',
NODE_Name                   : 'ノード名',
NODE_Port                   : 'ノードポート',
...
TranslatorAddr_4            : '',
TranslatorAddr_5            : '',
TranslatorName_1            : '[sekisanchi.eth](http://explorer.moac.io/address/0xf991119eea62eee1a6fdaa7f621e91a42f325fce)', /* Translator 1: Kazunori Seki / 関一典 */
TranslatorName_2            : '[MaySoMusician](http://explorer.moac.io/address/0x4cEE3D48603CbA315Bf8311492e3a2221a95273B)', /* Translator 2: MaySoMusician / 迷奏ミュージシャン */
...
TXFEE_Desc                  : 'トランザクション手数料は、トランザクションをブロックへ組み込むためにマイナーに支払われます。`ガスリミット` × `ガス価格`で算出されます。 [GWEI -> ETHの単位変換はこちらからどうぞ](https://www.MoacWalletOnline.com/helpers.html)',　/*The TX Fee is paid to miners for including your TX in a block. It is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://www.MoacWalletOnline.com/helpers.html)*/

VIEWWALLET_HidePrivKey      : '(隠す)',
VIEWWALLET_ShowPrivKey      : '(表示する)',
VIEWWALLET_Subtitle         : '異なったバージョンの秘密鍵をダウンロードしたり、お財布紙情報（ペーパーウォレット）を再印刷することができます。[Geth/Mistに口座をインポートする](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)際に必要になります。残高を確認するためには、[explorer.moac.io](http://explorer.moac.io/)のようなブロックチェーン・エクスプローラー サービスを使う事をおすすめします。',
...
HELP_3_Desc_3               : 'Navigate to the MoacWalletOnline.com "View Wallet Info" page.',
...
HELP_5_Title                : '5) How do I run MoacWalletOnline.com offline/locally?',
HELP_5_Desc_1               : 'You can run MoacWalletOnline.com on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page.',
...
HELP_5_Desc_9               : 'As we are constantly updating MoacWalletOnline.com, we recommend you periodically update your saved version of the repo.',
...
HELP_Desc                   : 'Do you see something missing? Have another question? [Get in touch with us](mailto:support@MoacWalletOnline.com), and we will not only answer your question, we will update this page to be more useful to people in the future!',
HELP_Remind_Title           : 'Some reminders',
HELP_Remind_Desc_1          : '**Ethereum, MoacWalletOnline.com & MyEtherWallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Ether**.',
HELP_Remind_Desc_2          : 'MoacWalletOnline.com & MyEtherWallet CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
