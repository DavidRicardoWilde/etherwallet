        ...
        <table class="table small table-condensed table-hover transaction-modal">
          <tbody>
            ...
            <tr>
              ...
              <td class="small text-left mono">{{parsedSignedTx.gasPrice.gwei}} GSHA <small>({{parsedSignedTx.gasPrice.eth}} MC)</small>
              </td>
            </tr>
            <tr>
              <td class="small text-right">Max TX Fee:</td>
              <td class="small text-left mono"> {{parsedSignedTx.txFee.eth}} MC <small>({{parsedSignedTx.txFee.gwei}} GSHA)</small></td>
            </tr>
            <tr>
