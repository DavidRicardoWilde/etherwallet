  ...
  <article class="collapse-container">
    ...
    <div ng-show="!wd">
      <p translate="VIEWWALLET_Subtitle">
        This page allows you to download different versions of private keys and re-print your paper wallet. If you want to check your balance, we recommend using a blockchain explorer like <a href="http://explorer.moac.io/" target="_blank" rel="noopener noreferrer">explorer.moac.io</a>.
      </p>
