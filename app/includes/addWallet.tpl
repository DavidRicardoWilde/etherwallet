<main class="tab-pane active"
    ...
    <article class="col-md-4 col-sm-6">
      ...
      <section ng-show="walletType=='watchonlyaccount'">
        ...
        <p class="text-danger" translate="ADD_Warning_1">
          You can add any account to "watch" on the wallets tab without uploading a private key. This does ** not ** mean you have access to this wallet, nor can you transfer Mc from it.
        </p>
  ...
  <article class="row" ng-if="showAddWallet">
    ...
    <section class="col-sm-4">
      ...
      <ul class="account-info">
        <li>
          <a href="http://explorer.moac.io/address/{{wallet.getAddressString()}}"
             target="_blank"
             rel="noopener noreferrer">
               http://explorer.moac.io/address/ {{wallet.getAddressString()}}
          </a>
        </li>
      </ul>
    </section>
